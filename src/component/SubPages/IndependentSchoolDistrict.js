        ...
        <div className="row justify-content-between">
          ...
          <div className="col-xl-7 col-lg-8">
              ...
              <div className="job-items">
                ...
                <div className="job-tittle">
                  <a href="#">
                    ...
                    <li>Independent School District</li>
            ...
            <div className="job-post-details">
              ...
              <div className="post-details2  mb-50">
                ...
                <ul>
                  <li>Knowledge of subjects assigned</li>
                  <li>
                  General knowledge of curriculum and instruction
                  </li>
                  <li>Ability to instruct students and manage their behavior</li>
              ...
              <div className="post-details2  mb-50">
                ...
                <ul>
                <li>Bachelor's degree in Biology or any related field</li>
                  <li>3 or more years of student teaching or approved internship</li>
      
                  <li>Experience in using effective communication skills to present information accurately and clearly.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="col-xl-4 col-lg-4">
            <div className="post-details3  mb-50">
              ...
              <ul>
                <li>
                  Posted at : <span>2022-07-06 15:09:27</span>
                </li>
                <li>
                  Location : <span>Jordan</span>
                </li>
                <li>
            ...
            <div className="post-details4  mb-50">
              ...
              <span>Independent School District</span>
              
              <ul>
                <li>
                  Name: <span>Independent School District </span>
                </li>
              
                <li>
                  Email: <span>awatson@nbisd.org</span>
                </li>  
                <li>
                  Phone : <span> +962 777 777 777</span>
                </li>
              </ul>
            </div>
          </div>
