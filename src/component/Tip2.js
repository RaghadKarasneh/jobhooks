          ...
          <div class="row">
            <div class="col-xl-12">
              <div class="hero-cap text-center">
                <p className='hero-text'>5 Books You Must Read  For Accountants</p>
                    </div>
                  </div>
                </div>
              </div>
...
<h1 className='mb-50 mt-50'>1. Accounting Made Simple (Mike Piper)</h1>
...
<h1 className='mb-50 mt-50'>2. Intermediate Accounting (Donald Kieso, Jerry Weygandt, and Terry Warfield)</h1>
...
<h1 className='mb-50 mt-50'>3. The Undoing Project (Michael Lewis)</h1>
...
<h1 className='mb-50 mt-50'>4. Thinking, Fast and Slow (Daniel Kahneman)</h1>
...
<h1 className='mb-50 mt-50'>5. The Little Book That Still Beats the Market (Joel Greenblatt)</h1>
